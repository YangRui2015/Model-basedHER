...
class ActorCritic: 
    ...
    def __init__(self, inputs_tf, dimo, dimg, dimu, max_u, o_stats, g_stats, hidden, layers, **kwargs):
        ...
        # o2 = self.o_stats.normalize(self.o2_tf)
        ...
        with tf.variable_scope('Q'):
            ...
            # input_Q = tf.concat(axis=1, values=[o2, g, self.u2_tf / self.max_u])
            # self.Q_u2_tf = nn(input_Q, [self.hidden] * self.layers + [1], reuse=True) 
