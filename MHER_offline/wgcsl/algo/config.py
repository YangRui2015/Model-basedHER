...
def prepare_params(kwargs):
    ...
    for name in ['buffer_size', 'hidden', 'layers','network_class','polyak','batch_size', 
                 ...
                 'scope', 'relative_goals', 'use_supervised', 'use_conservation', 'use_model_her', 'alpha']:
...
def configure_her(params):
    ...
    sample_supervised, her_sampler, conservation_sampler, model_based_her_sampler = make_sample_transitions(**her_params)
    random_sampler = make_random_sample(her_params['reward_fun'])
    samplers = {
        'random': random_sampler,
        'her': her_sampler,
        'supervised':sample_supervised,
        'conservation': conservation_sampler,
        'model': model_based_her_sampler
    }
