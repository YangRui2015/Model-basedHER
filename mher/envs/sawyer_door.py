...
# from mher.envs.env_util import (
#     get_stat_in_paths,
...
# from mher.envs.multitask_env import MultitaskEnv
# import os.path as osp
# from mher.envs import sawyer_door_hook
...
class SawyerDoorGoalEnv(Wrapper):
    def __init__(self, fixed_start=True, fixed_goal=False, threshold=0.02):
        config_key = 'all'
        if fixed_start:
            if fixed_goal:
